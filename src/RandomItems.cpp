...
namespace
{
    ...
    const std::vector<std::string> s_BlacklistedRepositoryIds{
        ...
        // Obvious clutter and low-value props observed in item-ids.txt.
        ...
        // Novelty melee and decorative prop clutter observed in item-ids.txt.
        ...
        // Internal, test, quest, and known-bad entries observed in item-ids.txt.
        ...
        // NPC, GL2, Outbreak, and Filur items observed in item-ids.txt.
        ...
        // Additional cure and rusty items observed in item-ids.txt.
        ...
        // Additional holiday and bottle items observed in item-ids.txt.
        ...
        // Additional glass and food items observed in item-ids.txt.
